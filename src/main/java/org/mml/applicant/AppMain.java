package org.mml.applicant;

/**
 * @Package: org.mml.applicant
 * @ClassName: AppMain
 * @Author: maml
 * @CreateTime: 2020/12/16 14:33
 * @Description:
 */
...
public class AppMain {
    ...
    private static String getRandomCharAndNumr(Integer length) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (b) { // 字符串
                // int choice = random.nextBoolean() ? 65 : 97; 取得 65 大写字母还是 97
                //小写字母
                str.append((char) (65 + random.nextInt(26)));// 取得大写字母
            } else { // 数字
